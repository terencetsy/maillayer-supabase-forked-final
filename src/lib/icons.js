...
export const FirebaseOutline = (props) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width="1em"
        height="1em"
...
export const Eye = (props) => (
    ...
    >
        <g
            ...
            color="currentColor"
        >
            <path d="M2 8s4.477-5 10-5s10 5 10 5"></path>
            <path d="M21.544 13.045c.304.426.456.64.456.955c0 .316-.152.529-.456.955C20.178 16.871 16.689 21 12 21c-4.69 0-8.178-4.13-9.544-6.045C2.152 14.529 2 14.315 2 14c0-.316.152-.529.456-.955C3.822 11.129 7.311 7 12 7c4.69 0 8.178 4.13 9.544 6.045"></path>
            <path d="M15 14a3 3 0 1 0-6 0a3 3 0 0 0 6 0"></path>
        </g>
    </svg>
);
...
export const PieChart = (props) => (
    ...
    >
        <g
            ...
            color="currentColor"
        >
            <path d="M20.5 15.828c-2.501 5.928-10.636 7.656-15.299 3.036C.63 14.334 2.045 6.13 8.057 3.5"></path>
            <path d="M17.683 12.5c1.888 0 2.832 0 3.441-.845c.023-.032.06-.088.081-.121c.548-.887.266-1.568-.299-2.93a10.18 10.18 0 0 0-5.51-5.51c-1.362-.565-2.043-.847-2.93-.3c-.033.021-.09.06-.121.082c-.845.61-.845 1.553-.845 3.44v2.111c0 1.92 0 2.88.596 3.477c.597.596 1.557.596 3.476.596z"></path>
        </g>
    </svg>
);

export const UserMinus01 = (props) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width="1em"
        height="1em"
...
export const ArrowBounce28Filled = (props) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width="1em"
        height="1em"
    ...
    >
        <path
            fill="#000000"
            d="M2 8a1 1 0 0 1 1-1h8a1 1 0 1 1 0 2H5.489l9.514 9.118l9.308-8.843a1 1 0 0 1 1.378 1.45l-10 9.5a1 1 0 0 1-1.38-.003L4 10.343V16a1 1 0 1 1-2 0z"
        ></path>
    </svg>
);
...
export const ContactBook = (props) => (
    ...
    >
        <g
            ...
            color="currentColor"
        >
            <path d="M4.5 10c0-3.771 0-5.657 1.172-6.828S8.729 2 12.5 2H14c3.771 0 5.657 0 6.828 1.172S22 6.229 22 10v4c0 3.771 0 5.657-1.172 6.828S17.771 22 14 22h-1.5c-3.771 0-5.657 0-6.828-1.172S4.5 17.771 4.5 14zm0-4H2m2.5 6H2m2.5 6H2"></path>
            <path d="M15.275 8.493a2 2 0 1 1-4 0a2 2 0 0 1 4 0M9.32 15.716c1.058-1.63 2.739-2.24 3.955-2.239s2.847.61 3.906 2.24a.33.33 0 0 1 .025.344c-.247.439-1.016 1.31-1.57 1.369c-.638.067-2.307.077-2.36.077s-1.773-.01-2.41-.077c-.556-.06-1.324-.93-1.572-1.37c-.061-.109-.043-.238.026-.344"></path>
        </g>
    </svg>
);
...
export const DatabaseSync = (props) => (
    ...
    >
        <g
            ...
            color="currentColor"
        >
            <path d="m13 17l1.023.594c.514-1.866 2.488-2.974 4.409-2.474a3.58 3.58 0 0 1 2.218 1.686M22 20l-1.023-.594c-.514 1.866-2.488 2.974-4.409 2.474a3.58 3.58 0 0 1-2.186-1.63"></path>
            <path d="M21 13v-1.5c0-4.478 0-6.718-1.391-8.109S15.979 2 11.5 2C7.022 2 4.782 2 3.391 3.391S2 7.021 2 11.5c0 4.478 0 6.718 1.391 8.109C4.618 20.835 6.503 20.98 10 20.998h1M2 11.5h19m-8.5-5h4"></path>
            <circle
                cx="7.75"
                cy="6.5"
                r="1.25"
...
export const Shield02 = (props) => (
    ...
    >
        <g
            ...
            color="currentColor"
        >
            <path d="M21 11.183V8.28c0-1.64 0-2.46-.404-2.995s-1.318-.794-3.145-1.314a25 25 0 0 1-3.229-1.173C13.023 2.266 12.424 2 12 2s-1.023.266-2.222.798c-.88.39-1.98.818-3.229 1.173c-1.827.52-2.74.78-3.145 1.314C3 5.82 3 6.64 3 8.28v2.903c0 5.625 5.063 9 7.594 10.336c.607.32.91.481 1.406.481s.799-.16 1.406-.48C15.937 20.182 21 16.807 21 11.182"></path>
            <path d="M14.5 11.5a2.5 2.5 0 1 1-5 0a2.5 2.5 0 0 1 5 0"></path>
        </g>
    </svg>
);

export const Home03 = (props) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width="1em"
        height="1em"
...
export const PlusSignCircle = (props) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width="1em"
        height="1em"
...
export const CheckmarkCircle02 = (props) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width="1em"
        height="1em"
...
export const MailOutgoing = (props) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width="1em"
        height="1em"
...
export const SaveFloppy = (props) => (
    ...
    >
        <g
            ...
            strokeWidth="1.5"
        >
            <path d="M21.25 9.16v7.987a4.1 4.1 0 0 1-1.204 2.901a4.113 4.113 0 0 1-2.906 1.202H6.86a4.113 4.113 0 0 1-2.906-1.202a4.1 4.1 0 0 1-1.204-2.901V6.853a4.1 4.1 0 0 1 1.204-2.901A4.113 4.113 0 0 1 6.86 2.75h8.35a3.004 3.004 0 0 1 2.25.998l3 3.415c.501.545.783 1.256.79 1.997"></path>
            <path d="M7 21.22v-5.241a1.995 1.995 0 0 1 2-1.997h6a2.002 2.002 0 0 1 2 1.997v5.241M15.8 2.81v4.183a1.526 1.526 0 0 1-1.52 1.528H9.72A1.531 1.531 0 0 1 8.2 6.993V2.75m1.946 15.108h3.708"></path>
        </g>
    </svg>
);
...
export const ArrowLeft02 = (props) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width="1em"
        height="1em"
...
export const LeftToRightListTriangle = (props) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width="1em"
        height="1em"
    ...
    >
        <path
            ...
            strokeLinejoin="round"
            strokeWidth="1.5"
            d="M11 5.5h10M5.4 16.893C6.467 17.607 7 17.964 7 18.5s-.533.893-1.6 1.607c-1.067.715-1.6 1.072-2 .804S3 19.93 3 18.5s0-2.143.4-2.411s.933.09 2 .804m0-13C6.467 4.607 7 4.964 7 5.5s-.533.893-1.6 1.607c-1.067.715-1.6 1.072-2 .804S3 6.93 3 5.5s0-2.143.4-2.411s.933.09 2 .804M11 12h10m-10 6.5h10"
            color="currentColor"
        ></path>
    </svg>
);
